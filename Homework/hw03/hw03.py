...
def missing_digits(n):
    ...
    True
    """
    def recursive(n, total):
        if n // 10 == 0:
            return total
        elif (n % 10 - (n // 10) % 10 == 1 or n % 10 == (n // 10) % 10):
            return recursive(n // 10, total)
        else:
            total += n % 10 - (n // 10) % 10 - 1 
            return recursive(n // 10, total)
...
def count_coins(change):
    ...
    def rec(change, descending):
        if change == 0:
            ...
            return 1
        return rec(change, descending_coin(descending)) + rec(change - descending, descending)
